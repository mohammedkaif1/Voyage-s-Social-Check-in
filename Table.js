    ...
    <div style={{ marginTop: '25px' }}>
      ...
      <div class="button">
        ...
        <FormControl component="fieldset">
          ...
          <div className='addResourceDiv' onClick={handleOpenModal}>
            <span>Add<span></span>Resource</span>
            <AddIcon></AddIcon>
      ...
      <TableContainer component={Paper} style={{marginTop:'60px',width:'100%',overflow:'auto'}}>
          ...
          <TableBody>
            {tableData.slice(page*rowperpage,page*rowperpage+rowperpage).map(item => (
              <TableRow key={item.employeeId} className="emp">
                ...
                <TableCell sx={{whiteSpace:'nowrap'}} align='center'>{item.eligibleForRotationPool==='1' ? 'Yes' :'No'}</TableCell>
