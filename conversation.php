...
$time=$_SESSION['time'];
$day=$_SESSION['day'];
$sql=mysqli_query($al,"SELECT * FROM tab WHERE email!='$email' and source='$source' and destination='$destination' and transport='$transport' and day1='$day' and time1='$time'");
$receiver=$_POST['user'];
$msg=$_POST['msg'];
$date=date('d-M-Y');
...
{
	mysqli_query($al,"INSERT INTO message(sender,receiver,msg,date,source,destination,tranport,time1,day1) VALUES('$email','$receiver','$msg','$date','$source','$destination','$transport','$time','$day')");
	$info="Message Sent";
}
?>
...
<br />
<?php
$r=mysqli_query($al,"SELECT * FROM message WHERE receiver='$email' and source='$source' and destination='$destination' and tranport='$transport' and time1='$time' and day1='$day' ORDER BY id DESC");
?>
...
<?php while($t=mysqli_fetch_array($r))
{
	...
	$o=mysqli_query($al,"SELECT * FROM tab WHERE email='$ee'");
...
<?php 
$r=mysqli_query($al,"SELECT * FROM message WHERE sender='$email' and source='$source' and destination='$destination' and time1='$time' and tranport='$transport' and day1='$day' ORDER BY id DESC LIMIT 10");
?>
<table cellpadding="4" cellspacing="4" class="table">
