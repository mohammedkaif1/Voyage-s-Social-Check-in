...
else
{
	...
	if($pass==$password)
	{
		mysqli_query($al,"delete from box");
		mysqli_query($al,"delete from message");
...
<a href="manageUsers.php">Manage Users</a><br /><br>
<a href="browse.php">Browse A Coustomer</a></br></br>
<a href="addadmin.php">Add A Admin</a></br></br>
<form method="post" action="">
<span class="tableHead" style="font-size:16px;">Delete All Messages from  Chatter Box  </span><br /></br>
...
<input type="submit" value="DELETE" class="commandButton" /></br></br>
<span class="info"><?php echo $info;?></span><br /></br>
